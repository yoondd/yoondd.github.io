...
<body>  
    <h1>Redux Study</h1>  
    <main>        <div id="component_red" class="box">  
  
        </div>        <div id="component_green" class="box">  
        </div>        <div id="component_blue" class="box">  
        </div>        <div id="component_orange" class="box">  
        </div>    </main>  
  
    <script>        function reducer(state, action){  
            console.log(state, action);  
            if( state === undefined ){  
                return { color: "purple" };  
            }  
        ...
        function red(){  
            ...
            document.querySelector("#component_red").innerHTML = `  
                ...
                <h2>Red</h2>                <button id="red" onclick=" store.dispatch({type:'change_color', color: 'red'}); ">Change</button>                </div>            `;  
        }  
        store.subscribe(red);  
        red();  
        ...
        function blue(){  
            ...
            document.querySelector("#component_blue").innerHTML = `  
                <div style="background-color: ${state.color}">  
                <h2>Blue</h2>                <button id="blue" onclick=" store.dispatch({type:'change_color', color: 'blue'}); ">Change</button>                </div>            `;  
        }  
        ...
        function green(){  
            ...
            document.querySelector("#component_green").innerHTML = `  
                <div style="background-color: ${state.color}">  
                <h2>green</h2>                <button id="green" onclick=" store.dispatch({type:'change_color', color: 'green'}); ">Change</button>                </div>            `;  
        }  
