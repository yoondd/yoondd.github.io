      ...
      <>
        <div style={{ textAlign: "center" }}>
          ...
          <div style={iconsRowStyle}>
            ...
            >
              <svg style={gitIconStyle} viewBox="0 0 24 24" fill="currentColor">
                <path
            ...
            <a
              ...
              onMouseLeave={(e) => e.currentTarget.style.transform = "scale(1)"}
            >
              <svg style={gitIconStyle} viewBox="0 0 24 24" fill="#FC6D26">
                <path
            ...
            <img
              src="https://hits.sh/yoondd.github.io.svg?view=today+total"
              alt="방문자 카운터"
              style={visitorCounterStyle}
            />
          </div>
        </div>
